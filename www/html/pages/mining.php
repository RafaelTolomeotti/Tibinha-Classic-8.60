														...
														<div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiarl/images/global/content/table-shadow-rm.gif);" >
															<div class="TableContentContainer" >
																<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																	<tr style="background-color:#D4C0A1;" >
																		<td><div style="text-align: justify;">
																			<p><b>Armas refinadas</b> teram um estato dentro do jogo escrito [up] na qual a mesma passa ter um ataque de 74 podendo ser encantada normalmente pra diversos elementos, essas armas aparecem no site ao ver itens dos personagens são raras devido ao empenho para forja uma, a taxa de sucesso é de apenas 40% enquanto o servidor estiver no seu inicio, apois isso sera mudado para taxa de sucesso de 10% a cada cristal usado para que se tornem cada vez mais raras!<br><br> <small>(<i>Clique na imagem pra ampliar</i>.)</small></p></div>
																		</td>
																		<td width="20%">
																			<a class="fancybox-media" href="/images/mining/armarefine.png">
																				<img src="/images/mining/armarefine.png" width="130px" border="1">
																			</a>
																		</td>
																	</tr>
																</table>
