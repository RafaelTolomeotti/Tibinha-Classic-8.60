...
<div id="LayerPop" style="display:block; position:absolute; left:0px; top:-590px; background-color:#1e1e22; width:100%; height:100%; z-index:100;margin:0px;opacity:0.75;"></div>
<div id="LayerPop2" style="position: absolute; top: -620px; margin:auto; padding:auto; width: 100%; z-index: 5000;" align="center">
  <a href="javascript:void();" onclick="document.getElementById('LayerPop').style.display = 'none';document.getElementById('LayerPop2').style.display = 'none'">
    <b><h3><font color="white"><img src="https://i.imgur.com/dqM5Wgi.png" width="35"></font></h3></b>
  </a>
  <a href="?subtopic=accountmanagement" target="_BLANK">
    <img src="images/promotion.png" border="0">
  </a>
  <br>
</div>

<script>
  // Define a função para fechar o POP
  function fecharPop() {
  ...
  var tempoEspera = 10000; // 10 segundos
  
  // Define o temporizador para executar a função de fechar o POP
  setTimeout(fecharPop, tempoEspera);
</script>
...
//FEATURED ARTICLE
	...
	<div id="FeaturedArticle" class="Box">
		...
		<div class="Border_2">
			<div class="Border_3">
				<div class="BoxContent" style="background-image:url('.$layout_name.'/images/content/scroll.gif);">
					<table style="background-color: #d4c0a1;border-radius: 11px 10px 10px;border: 2px solid #350404;box-shadow: 0 3px 2px 0 rgba(0,0,0,0.42),0 8px 7px 0 rgba(0,0,0,0.2)!important;" bgcolor="#D4C0A1" border="0" cellpadding="4" cellspacing="1" width="100%"> 
						<tbody>
							<tr>
								<td style="background-image:url(./layouts/tibiarl/images/content/title-background-green.gif); border-radius: 10px;font-size: 12;text-shadow: -1px -1px 0 rgba(0,0,0,0.50),1px -1px 0 rgba(0,0,0,0.50),-1px 1px 0 rgba(0,0,0,0.50),1px 1px 0 rgba(0,0,0,0.50);" align="center" class="white">
                                                ...
                                                <tr>
                                                    <td>
														<table border="0" cellpadding="3" cellspacing="1" width="100%">                                  
															<tbody>							
																<center>
																	<b>IP: </b> Tibinha.Online • <b>Porta:</b> 7171 • <b>Client: </b> 8.6 • <a href="/?subtopic=download">» Downloads «</a><br>
																</center>												
																<center>
																	<img style="cursor: pointer;" src="https://www.tibiawiki.com.br/images/f/ff/Icone8.png" hspace="4" vspace="6" width="65" height="65" align="left">	
																	<img style="cursor: pointer;" src="https://www.tibiawiki.com.br/images/6/63/Icone7.png" hspace="4" vspace="6" width="65" height="65" align="right">	
																	<b style="">Rates: </b>Início: 300x | Magic: '.$config['server']['rateMagic'].'x | Skills: '.$config['server']['rateSkill'].'x 
																	<br>
																	<img src="./layouts/tibiarl/images/separator.png" style="margin: 2px;">
																	<br>
																	<span style="font-size: 11px;">
																		Para mais informações clique <a href="/?subtopic=serverinfo"><i class="fa fa-tags" aria-hidden="true"></i> 
																		aqui!</a>
																	</span>
																</center>
																<center>
																	<span style="font-size: small;">
																		<img src="images/letters/letter_martel_S.gif" alt="" width="24" height="23" />eja muito bem vindo ao servidor alternativo <strong>'.$config['server']['serverName'].'</strong>
																	</span>
																	<br>
<div style="text-align:center">
  <marquee scrollamount="3">
    <span style="color: #4CAF50; text-shadow: 1px 1px #000; font-size: 14px;">Mapa rico em quests e hunts</span> |
    <span style="color: #FFEB3B; text-shadow: 1px 1px #000; font-size: 14px;">Balanceamento elaborado</span> |
    <span style="color: #2196F3; text-shadow: 1px 1px #000; font-size: 14px;">Sistemas exclusivos</span> |
    <span style="color: #E91E63; text-shadow: 1px 1px #000; font-size: 14px;">Eventos automáticos</span> |
    <span style="color: #9C27B0; text-shadow: 1px 1px #000; font-size: 14px;">Guerras entre guilds emocionantes</span> |
    <span style="color: #FF9800; text-shadow: 1px 1px #000; font-size: 14px;">Descubra tudo o que o Tibinha tem a oferecer!</span> |
    <span style="color: #795548; text-shadow: 1px 1px #000; font-size: 14px;">Host com ping baixo - BR</span> |
    <span style="color: #607D8B; text-shadow: 1px 1px #000; font-size: 14px;">Potes e Runas Infinitos</span> |
    <span style="color: #FFC107; text-shadow: 1px 1px #000; font-size: 14px;">Dificuldade estagiada para diferentes experiências</span> |
	<span style="color: #00FFFF; text-shadow: 1px 1px #000; font-size: 14px;">Bosst de Criatura todos os DIAS!</span> |
	<span style="color: #FF00FF; text-shadow: 1px 1px #000; font-size: 14px;">Bless grátis até nivel 140</span> |
    <span style="color: #9E9E9E; text-shadow: 1px 1px #000; font-size: 14px;">Servidor que não é pay to win</span>
  </marquee>
</div>
<br>
																</center>																	
					...
					<table style="background-color: #d4c0a1;border-radius: 11px 10px 10px;border: 2px solid #350404;box-shadow: 0 3px 2px 0 rgba(0,0,0,0.42),0 8px 7px 0 rgba(0,0,0,0.2)!important;" bgcolor="#D4C0A1" border="0" cellpadding="4" cellspacing="1" width="100%">
						<tbody>
							<tr>
								<td style="background-image:url(./layouts/tibiarl/images/content/title-background-green.gif); border-radius: 10px;font-size: 12;text-shadow: -1px -1px 0 rgba(0,0,0,0.50),1px -1px 0 rgba(0,0,0,0.50),-1px 1px 0 rgba(0,0,0,0.50),1px 1px 0 rgba(0,0,0,0.50);" align="center" class="white">
									<b><img src="https://www.tibiawiki.com.br/images/5/59/Red_Skull.gif" width="10" height="10"> TOP KILLS <img src="https://www.tibiawiki.com.br/images/5/59/Red_Skull.gif" width="10" height="10"></b>
								</td>
							</tr>
							<tr>
								<td>
					...
					<table style="background-color: #d4c0a1;border-radius: 11px 10px 10px;border: 2px solid #350404;box-shadow: 0 3px 2px 0 rgba(0,0,0,0.42),0 8px 7px 0 rgba(0,0,0,0.2)!important;" bgcolor="#D4C0A1" border="0" cellpadding="4" cellspacing="1" width="100%"> 
						<tbody>
							<tr>
								<td style="background-image:url(./layouts/tibiarl/images/content/title-background-green.gif); border-radius: 10px;font-size: 12;text-shadow: -1px -1px 0 rgba(0,0,0,0.50),1px -1px 0 rgba(0,0,0,0.50),-1px 1px 0 rgba(0,0,0,0.50),1px 1px 0 rgba(0,0,0,0.50);" align="center" class="white">
									<b><img src="https://www.tibiawiki.com.br/images/d/d6/Banner_red.gif" width="10" height="10"> TOP GUILDS <img src="https://www.tibiawiki.com.br/images/d/d6/Banner_red.gif" width="10" height="10"></b>
								</td>
							</tr>
							<tr>
								<td>
