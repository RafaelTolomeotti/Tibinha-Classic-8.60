...
c) O doador está ciente que a doação não pode ser devolvida.
	...
	<div class="TableContainer">
      ...
      if ($config['site']['useDeposit']) {
        ...
        <TR BGCOLOR="#505050">
          <TR BGCOLOR=#D4C0A1>
            <TD><input type="radio" name="method" value="3"> Depósito bancário - Depósitos/PIX/DOCS/Transferências bancárias <b><small><font color="green">(Com Bonificação)</font></small></b></TD>
        </TR>';
    }
