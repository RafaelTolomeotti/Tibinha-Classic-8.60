...
local POTIONS = {
	...
	[7590] = {empty = 7635, splash = 47, mana = {280, 430}, level = 80, vocations = {isSorcerer, isDruid}, vocStr = "sorcerers and druids"}, -- great mana potion

	[8472] = {empty = 7635, splash = 43, health = {300, 550}, mana = {160, 260}, level = 80, vocations = {isPaladin}, vocStr = "paladins"} -- great spirit potion
}
