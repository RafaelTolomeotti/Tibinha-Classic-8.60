-- Config # --
local areafrom = {x = 695, y = 116, z = 8} -- ENTRADA from
local areato = {x = 706, y = 127, z = 8} -- ENTRADA to
local pos_exit = {x = 708, y = 122, z = 8} -- POS SAIDA
local pos_entrance = {x = 706, y = 122, z = 8} -- POS ENTRADA

local global_stor = 30056
local player_stor = 45325
