-- Config # --
local areafrom = {x = 713, y = 116, z = 8} -- ENTRADA from
local areato = {x = 724, y = 127, z = 8} -- ENTRADA to
local pos_exit = {x = 711, y = 122, z = 8} -- POS SAIDA
local pos_entrance = {x = 713, y = 122, z = 8} -- POS ENTRADA

local global_stor = 30057
local player_stor = 45326
