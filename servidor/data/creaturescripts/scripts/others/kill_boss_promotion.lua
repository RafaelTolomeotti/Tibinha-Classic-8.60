...
if isPlayer(target) then
	...
	if getCreatureName(target) == "Agathodemon" and bit.band(flags, 1) == 1 then
		doCreatureSay(cid, "O teleport vai fechar em 1 minuto.", TALKTYPE_ORANGE_1, false, 0, pos_msg)
		countTextRed(cid, pos_msg, 60)
		countTutorialArrow(cid, pos_msg, 60)
	end
	return true
end