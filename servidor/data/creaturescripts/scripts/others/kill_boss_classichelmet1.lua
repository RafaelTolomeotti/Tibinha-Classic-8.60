...
if isPlayer(target) then
	...
	if getCreatureName(target) == "Hotepsekhemui" and bit.band(flags, 1) == 1 then
		doCreatureSay(cid, "O teleport vai fechar em 2 minutos.", TALKTYPE_ORANGE_1, false, 0, pos_msg)
		countTextRed(cid, pos_msg, 120)
		countTutorialArrow(cid, pos_msg, 120)
	end
	return true
end