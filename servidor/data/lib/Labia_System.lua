...
Labia_System = {
             DiffPremiumAndFree = false, -- se o premium e free vao ter diferença no ganho de exp 
...
--[[haunted blade]]             [7407] = {price = 8000, exp = {equal = 3, premium = 4}},
--[[tower shield]]              [2528] = {price = 8000, exp = {equal = 3, premium = 4}},
--[[royal helmet]]              [2498] = {price = 30000, exp = {equal = 3, premium = 4}},
