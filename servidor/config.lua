-- The OTX Server Config
	...
	ownerName = "CnSoft"
	ownerEmail = "nohave"
	url = "www.tibinha.online"
	location = "brazil"

	-- Messages
	motd = "Welcome to the Tibinha Server! / Bem vindo ao Tibinha!"
	serverName = "ClassicTibinha"
	loginMessage = "Welcome to The Tibinha Server!"
